...
export const Route = createFileRoute("/seller/settings/security")({
      ...
      <div className="mt-6 rounded-3xl border border-border bg-card p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <div className="text-sm font-semibold">Protect your business account</div>
            <div className="mt-1 text-xs text-muted-foreground">
              Use a unique password and keep access to this seller account private.
            </div>
          </div>
        </div>
      </div>
